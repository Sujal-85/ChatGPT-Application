...
function Sidebar() {
  return (
    // <div className="w-1/5 bg-gray-100 p-2 shadow-lg" style={{ backgroundColor: "#f4f4f4" }}>
      <div className="w-1/5 bg-gray-100 p-2 shadow-lg" style={{backgroundColor: "#f4f4f4",}}>
      {/* <h1 className="text-2xl font-bold mb-6">ChatGPT</h1> */}

      <button className="icon-button" style={{marginLeft:"30px"}}>
      <svg
        width="32"
        height="32"
        viewBox="0 0 24 24"
    ...
    <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="icon-xl-heavy text-gray-500"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <button
      className="p-2 rounded-lg hover:bg-blue-300 focus:ring-2 focus:ring-blue-400 focus:outline-none"
      aria-label="Icon Button" style={{marginLeft:"20px"}}
    >
      <svg
        width="32"
        height="32"
      ...
      <div className="flex flex-col space-y-4">
        ...
        <a
          title="ChatGPT"
          className="no-draggable group rounded-lg active:opacity-90 bg-[var(--item-background-color)] h-12 text-sm flex items-center gap-2.5 p-2"
          href="/"
        >
          <div className="flex h-12 w-12 items-center justify-center text-token-text-secondary" style={{ fontSize: "32px" }}>
          ...
          <div className="grow overflow-hidden text-ellipsis whitespace-nowrap text-sm text-token-text-primary" style={{ fontSize: "18px" }}>
            ChatGPT
          </div>
        </a>
      ...
      >
        <Section title="Today">
          <li style={{ marginBottom: "20px" }}>Recipe Creation from Supplies</li>
          <li style={{ marginBottom: "20px" }}>Tech fest vehicle use</li>
          <li style={{ marginBottom: "20px" }}>Todo App with Notepad</li>
          <li style={{ marginBottom: "20px" }}>Image and Video Upload</li>
        </Section>
        <br />
        <Section title="Yesterday">
          <li style={{ marginBottom: "20px" }}>Graph Walk Minimum Cost</li>
          <li style={{ marginBottom: "20px" }}>Remove FAMT Duplication</li>
          <li style={{ marginBottom: "20px" }}>Stock Price Prediction ML</li>
          <li style={{ marginBottom: "20px" }}>File path error fix</li>
        </Section>
        <br />
      ...
      <div className="" style={{ marginTop: "60px", backgroundColor: "#f4f4f4" }}>
        <button className="w-full text-black py-2 flex items-start">
          <div className="flex items-center mr-4">
            <img src={Icon1} alt="Upgrade Icon" className="w-16 h-14" />
          </div>
          <div>
            <p className="mr-24" style={{ fontSize: "20px" }}>Upgrade plan</p>
            <p className="text-xs text-gray-400 mt-2" style={{ fontSize: "16px" }}>
